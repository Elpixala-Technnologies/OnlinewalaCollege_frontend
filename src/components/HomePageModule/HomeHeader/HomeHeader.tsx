...
import AuthModal from "@/components/AuthUi/AuthModal/AuthModal";
...
function HomePageHeader() {
  ...
  return (
    <>
      <div className="px-4 xl:px-12 flex justify-between items-center relative bg-[#3455FF] py-4">
        <Link href={"/"}>
          <h1 className="text-2xl xl:text-3xl">
            <span className="text-white text-opacity-80 font-extrabold">
              Online
            </span>
            <span className="text-blue-400 font-extralight">wala</span>
            <span className="text-[#42D7E1] text-opacity-80 font-extrabold">
              college
            </span>
          </h1>
        </Link>
        ...
        {/* Menu items */}
        <div
          className={`lg:flex xl:gap-10 gap-4 lg:items-center absolute lg:static left-0 top-[102px] w-64 z-50 lg:w-auto bg-white lg:bg-transparent shadow-lg lg:shadow-none transition-all duration-300 ease-in-out transform text-white ${
        ...
        <div className="hidden lg:flex items-center gap-6">
          <div
            className="bg-blue-50 flex items-center gap-5 px-4 py-1 rounded-md cursor-pointer"
